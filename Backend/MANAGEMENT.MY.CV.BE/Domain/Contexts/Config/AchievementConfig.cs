...
/// <summary>
/// Setting schema for Achievement table
/// </summary>
public class AchievementConfig : IEntityTypeConfiguration<Model.Achievement>
{
    public void Configure(EntityTypeBuilder<Model.Achievement> entity)
    {
